...
#Add your code here!
my_sum = mystery_value_1 + mystery_value_2
my_difference = mystery_value_1 - mystery_value_2
my_product = mystery_value_1 * mystery_value_2
my_quotient = mystery_value_1 / mystery_value_2

print("The sum is {0}, the difference is {1}, the product is {2}, and the quotient is {3}.".format(my_sum, my_difference, my_product, my_quotient))
