...
def dimes_amm():
    return dimes_value * dimes
def nickels_amm():
    return nickels_value * nickels
def pennies_amm():
    return pennies_value * pennies

def countdown(): 
    return amount - (quarters_amm() + dimes_amm() + nickels_amm() + pennies_amm())

quarters = countdown() // quarters_value
dimes = countdown() // dimes_value
nickels = countdown() // nickels_value
pennies = countdown() // pennies_value
